...
namespace Expy
{
    ...
    public class SliverMoveComponent : BaseCompiledCSharpComponent{

        ImageOverlayComponent image = null;
        ...
        public void start_routine() {
            // ...
            image = (ImageOverlayComponent)Static.Components.get("image");

            //List<Vector3> tr = c.get_transform("transformation");
        }

        public void update() {

            //image.c.set("transform") 



            //SliderOverlayComponent slider = (SliderOverlayComponent) Static.Components.get("slider");
            //slider.set_value(a * 0.001f);
            //a++;
            //a = a % 1000;                
        }
        ...
        public void update_parameter_from_gui(Expy.XML.Arg arg) {
            ...
            Static.Log.message(arg.Name + " "+ arg.Value);
            // example
            //if (arg.Name == "angle x"){

            Static.Log.message("a");
            var v = p.c.get<float>("angle x");
            ...
            image.c.set("transformation", tr);
            //var tr = image.c.get_transform("transform");

            Static.Log.message("d");
            image.resize_image();
            Static.Log.message("e");
            //}
        }
    }
}
...
//{
//    public bool firstFrameDown = false;
//    public bool firstFrameUp = false;
