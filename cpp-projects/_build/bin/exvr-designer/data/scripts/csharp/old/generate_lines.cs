...
namespace Ex{
    ...
    public class GenerateLinesComponent : BaseCompiledCSharpComponent{

        LinesComponent lines = null;
        // ### Ex component flow functions, uncomment to use
        // # main functions
        public override bool initialize() {
            lines = get<LinesComponent>("Lines");
            return true; 
        }
        ...
        public override void start_routine() {
            ...
            for(int ii = 0; ii < 20; ++ii) {
                positions[ii] = new Vector3(
                    0.001f * rand.Next(-1000, 1000),
                    0.001f * rand.Next(-1000, 1000),
                    0.001f * rand.Next(-1000, 1000)
                );
            ...
            log_message("Init with color: " + color);
            lines.add_line(0.25f, color, positions);
        }
