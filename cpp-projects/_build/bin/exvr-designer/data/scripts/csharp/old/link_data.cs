...
namespace Ex{
    ...
    public class LinkDataComponent : BaseCompiledCSharpComponent{
        ...
        public override void slot1(object value) {
            ...
            var v1 = (StringAny)value;
            if (v1.str == "Knee") {
                invoke_signal1(v1);
            } else if (v1.str == "LHand") {
                var body = (QualisysTrackedBody)v1.value;
                invoke_signal2(new IdAny(2, body.transform.position));
                invoke_signal2(new IdAny(3, body.transform.eulerAngles));
                invoke_signal3(new StringAny("left_hand", body));
            } else if (v1.str == "RHand") {
                var body = (QualisysTrackedBody)v1.value;
                invoke_signal2(new IdAny(0, body.transform.position));
                invoke_signal2(new IdAny(1, body.transform.eulerAngles));
                invoke_signal3(new StringAny("right_hand", body));
            }
        }
