...
namespace Ex{
    ...
    public class HeadTargetComponent : BaseCompiledCSharpComponent{

        HumanoidControllerComponent avatar = null;
        SphereComponent sphereHead = null;
        SphereComponent sphereCamera = null;
        ...
        public override bool initialize() {
            avatar = get<HumanoidControllerComponent>("Humanoid controller");
            sphereHead = get<SphereComponent>("SphereHead");
            sphereCamera = get<SphereComponent>("SphereCamera");
        ...
        public override void pre_update() {
            ...
            var head = avatar.get_target_transform("head");

            sphereHead.transform.position = head.position;
            sphereHead.transform.rotation = head.rotation;

            sphereCamera.transform.position = ExVR.VR().bothEyesCamera.transform.position;
            sphereCamera.transform.rotation = ExVR.VR().bothEyesCamera.transform.rotation;
        }
