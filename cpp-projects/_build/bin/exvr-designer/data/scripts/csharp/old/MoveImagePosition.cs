...
namespace Expy{
    ...
    public class MoveImageComponent : BaseCompiledCSharpComponent{
        ...
        public void start_experiment() {
            ...
            go.layer = (int)Static.Layers.Id.BothEyes;
        ...
        public void update() {
            var compo = ExComponent.get("Image");
            var pos = compo.c.get_vector3("position");        
            compo.c.set_vector3("position", pos + new Vector3(0, 0, 1));
    
            //Static.Log.message(compo.name + " " + compo.c.get_vector3("position"));
        }
