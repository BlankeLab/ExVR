...
namespace Ex{
    ...
    public class GreenBallTrackingComponent : BaseCompiledCSharpComponent{
        ...
        public override bool initialize() {
            ...
            cloudMesh = scaner.m_cloudsGO[0].GetComponent<MeshFilter>().mesh;
        ...
        public override void post_update() {
            ...
            int ii = 0;
            var vertices = scaner.m_cloudsGO[0].GetComponent<MeshFilter>().mesh.vertices;
            ...
            //foreach (var c in scaner.m_cloudsGO) {

            //    var mesh = c.
            //    if (mesh.vertexCount > 0) {
            //        log_message("" + cloudMesh.vertexCount + " " + ii);
            //    }
            //    ++ii;
            //}
        ...
        public override void slot1(object value) {
            Debug.Log("mean " + (Vector3)value);
            sphere.transform.position = (Vector3)value;
        }
