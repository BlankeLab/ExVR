...
namespace Expy{
    ...
    public class TestComponent : BaseCompiledCSharpComponent{
        ...
        public void start_experiment() {
            // ...            
            p.log("start_experiment");
            Component compo = Component.get("CSharp script_02");
            //if (compo != null) {
