...
public class MirrorCameraScript : MonoBehaviour
{
    ...
    internal void RenderMirror()
    {
        ...
        //Debug.Log("cameraLookingAtThisMirror " + Time.frameCount + " " + cameraLookingAtThisMirror.name + " "+ cameraLookingAtThisMirror.stereoActiveEye + " "+ cameraLookingAtThisMirror.stereoTargetEye);
        ...
        try
        {
            ...
            else
            {
                ...
                // TEST
                mirrorMaterial.SetMatrix("_ReflectionMat", reflectionMatrix);
                mirrorMaterial.SetMatrix("_WorldMat", worldToCameraMatrix);
                // END TEST
